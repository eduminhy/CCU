...
<head>
<meta name ="google-signin-client_id" content="426256303189-882dlbi4n3r50pgtqo5q1b4hesjik5mu.apps.googleusercontent.com">
</head>
...
function onSignIn(googleUser) {
	...
	$.ajax({
		...
		, data: {personFields:'birthdays', key:'AIzaSyACSwYDDRCLex-scxMjSkbni0UAD1lFjG4', 'access_token': access_token}
		, method:'GET'
	})
	.done(function(e){
        //프로필을 가져온다.
...
<!-- 	<a href="javascript:kakaoLogin();"><img src="../img/kakaoicon.png"  id="kakaoicon"></a>	 -->
	...
	<div class="logincontainer">
		<form method="post" action="/user/loginOk" id="log">
			...
			<li><a href="/user/signup">회원가입</a></li> <br /> 
		</form>
		</div>
