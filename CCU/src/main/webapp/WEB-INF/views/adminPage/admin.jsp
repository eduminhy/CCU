			...
			<div>
				...
				<div>
					...
					<div class="admindata">
						<div>
							<button type="button"
								onclick="location.href='/dBData/showInputMain' ">공연관련
								데이터 넣기</button>
						</div>
						<div>
							<button type="button"
								onclick="location.href='/dBData/festivalInputMain' ">축제관련데이터
								넣기</button>
						</div>
						<div>
							<button type="button"
								onclick="location.href='/dBData/popularInputMain' ">장르별
								인기순위데이터 넣기</button>
						</div>
						<div>
							<button type="button"
								onclick="location.href='/dBData/ChildInputMain' ">아동
								장르데이터 넣기</button>
						</div>
						<!-- 					<button class="newdata" style="width: 300px; height: 300px;">클릭하여 공연데이터 -->
						<!-- 						최신화</button> -->
					</div>
					<br /> <br />
				</div>
				...
				<div>
					...
					<div class="playMeetingListSearch">
						<form method="get" action="/admin"
							class="playMeetingListSearchFrm">
						...
						<div class="UserDiv43">
							...
							<div>
								<form method="get" action="/admin" class="searchFrm5">
									...
									</select> <input type="text" name="searchWord5" class="searchWord5" />
						...
						<div class="container">
							...
							<div>
								<form method="get" action="/admin" class="searchFrm3">
									...
									</select> <input type="text" name="searchWord3" class="searchWord3" />
									<input type="submit" value="Search" />
								</form>
